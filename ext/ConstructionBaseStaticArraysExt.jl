...
ConstructionBase.constructorof(::Type{<:SArray{S}}) where {S} = SArray{S}
ConstructionBase.constructorof(::Type{<:MArray{S}}) where {S} = MArray{S}
ConstructionBase.constructorof(::Type{<:SizedArray{S}}) where {S} = SizedArray{S}
